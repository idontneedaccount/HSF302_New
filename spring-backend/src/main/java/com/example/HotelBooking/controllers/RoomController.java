...
public class RoomController {
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    public ResponseEntity<Response> getAllRoomsForAdmin(){
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    public ResponseEntity<Response> deactivateRoom(@PathVariable Long id){
        return ResponseEntity.ok(roomService.deleteRoom(id));
    }

    @PutMapping("/reactivate/{id}")
    @PreAuthorize("hasAuthority('ADMIN')")
    public ResponseEntity<Response> reactivateRoom(@PathVariable Long id){
        return ResponseEntity.ok(roomService.reactivateRoom(id));
    }

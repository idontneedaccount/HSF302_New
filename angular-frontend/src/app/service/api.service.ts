...
export class ApiService {
  ...
  updateProfile(userData: any): Observable<any> {
    return this.http.put(`${ApiService.BASE_URL}/users/update`, userData, {
      headers: this.getHeader(),
    });
  }
  ...
  getAllRoomsForAdmin(): Observable<any> {
    return this.http.get(`${ApiService.BASE_URL}/rooms/admin/all`, {
      headers: this.getHeader(),
    });
  }
  ...
  deactivateRoom(roomId: string): Observable<any> {
    return this.http.put(`${ApiService.BASE_URL}/rooms/deactivate/${roomId}`, null, {
      headers: this.getHeader(),
    });
  }

  reactivateRoom(roomId: string): Observable<any> {
    return this.http.put(`${ApiService.BASE_URL}/rooms/reactivate/${roomId}`, null, {
      headers: this.getHeader(),
    });
  }
